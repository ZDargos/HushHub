...
int PeakThreshold = 400;                  
// Threshold for reading in order to add to limiter for alert

int ThreshTime = 15000;
// Amount of time before NumPeaks resets

int GracePeriod = 1 * 1000;                // (left number is #seconds) Number of milliseconds of grace given between potential peak readings

int NumPeaksPermitted = 4;                
// Number of threshold breaks in a row before alert sent
...
String message = "Alert Sent";
String AlertID = "123456";
